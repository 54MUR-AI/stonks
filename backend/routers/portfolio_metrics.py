...
from ..schemas.portfolio import PortfolioMetrics
...
from ..analytics.benchmarks import get_benchmark_data, get_benchmark_info
...
async def get_portfolio_metrics(
    ...
    indicators: List[str] = Query([], regex='^(SMA|EMA|BB|RSI|MACD)$'),
    ...
    if indicators:
        technical_indicators = calculate_all_indicators(portfolio_values, indicators)
